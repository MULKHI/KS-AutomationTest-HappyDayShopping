...
Mobile.comment('Scenario : Checkout enter field Full Name with unique character')
...
'Enter Full Name with unique character'
Mobile.setText(findTestObject('Deliver or Ship/EditText_Field Full Name'), '@#%^&*("', 0)
...
'RUWI'
Mobile.tap(findTestObject('Object Repository/Deliver or Ship/CheckedTextView_RUWI'), 0)
...
'Expected Result : Users can\'t checkout with enters unique character on field Full Name'
Mobile.comment('BUG : Users can checkout with enters Full Name with unique character')

'there should be an error message like this "invalid name"'
