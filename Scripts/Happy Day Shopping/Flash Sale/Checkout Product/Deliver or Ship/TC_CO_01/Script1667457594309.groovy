...
Mobile.comment('Scenario : Checkout product use option Deliver or Ship')
...
'BUG : button Continue disable cannot working'
Mobile.tap(findTestObject('Deliver or Ship/Button_Continue second'), 0)

'Expected Result : Users can tap Continue button and navigate to payment page'
Mobile.comment('BUG : button Continue second cannot working')
