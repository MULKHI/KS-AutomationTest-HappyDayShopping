...
Mobile.comment('Scenario : Checkout enter field Phone with alphabet')
...
'Enter Phone with alphabet'
Mobile.setText(findTestObject('Deliver or Ship/EditText_Field Phone'), 'abcdefg', 0)
