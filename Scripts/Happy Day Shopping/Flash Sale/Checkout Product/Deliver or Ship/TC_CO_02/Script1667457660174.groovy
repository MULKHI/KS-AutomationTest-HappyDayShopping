...
Mobile.comment('Scenario : Checkout product with invalid format email')
...
Mobile.setText(findTestObject('Deliver or Ship/EditText_Field Email Address'), 'thiswrong@.com', 0)
...
'Users will get error massage "This email address doesn’t look right. Please make sure that you’ve entered your email correctly."'
Mobile.verifyElementText(findTestObject('Deliver or Ship/TextView_Error message invalid format email'), 'This email address doesn’t look right. Please make sure that you’ve entered your email correctly.')
