...
Mobile.setText(findTestObject('Object Repository/Flash Sale/EditText_Quantity'), '0', 0)
...
'Expected Result : Users can\'t add 0 product'
Mobile.comment('BUG : Users can add 0 product')
