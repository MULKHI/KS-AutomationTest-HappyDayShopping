...
Mobile.comment('Scenario : Add product with 0 Quantity')
...
Mobile.clearText(findTestObject('Flash Sale/EditText_Quantity'), 0)
...
'Expected Result : Users can\'t add product without enter Quantity'
Mobile.comment('BUG : Users can add without enter Quantity')

'there should be an error message like this "enter quantity"'
